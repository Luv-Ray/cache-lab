#ifndef __FULLY_ASSOC_CACHE_HH__
#define __FULLY_ASSOC_CACHE_HH__

#include <unordered_map>

#include "base/statistics.hh"
#include "mem/port.hh"
#include "params/FullyAssocCache.hh"
 ...
 */
class FullyAssocCache : public ClockedObject
{
private:
  /**
  ...
  private:
    ...
    /// The object that owns this object (FullyAssocCache)
    FullyAssocCache *owner;
  ...
  public:
     ...
     */
    CPUSidePort(const std::string &name, int id, FullyAssocCache *owner)
     ...
     * This is a convenience function for the FullyAssocCache to send pkts.
     *
     ...
     * from the FullyAssocCache whenever it is unblocked.
     */
    void trySendRetry();
  ...
  public:
     ...
     * Constructor. Just calls the superclass constructor.
     */
    MemSidePort(const std::string &name, FullyAssocCache *owner)
...
public:
  /** constructor
   */
  FullyAssocCache(const FullyAssocCacheParams &params);
...
#endif // __FULLY_ASSOC_CACHE_HH__
